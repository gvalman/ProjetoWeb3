...
function IniciarMapa() {
    ...
    L.geoJson(dados, {
        ...
        onEachFeature: function (feature, layer) {
            ...
            layer.bindPopup("<h2>" + feature.properties.bairro_nome + "</h2><br/><i id='" + feature.properties.bairro_codigo + "' class='fa fa-thumbs-o-up' onclick='openNavRight()' style='font-size:72px;color:green;' title='O que gostou?'></i><i class='fa fa-thumbs-o-down' style='font-size:72px;color:red;' title='O que não gostou?'></i>");
