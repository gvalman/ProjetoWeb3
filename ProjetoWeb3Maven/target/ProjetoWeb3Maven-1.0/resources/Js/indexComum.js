...
function IniciarMapa() {
    ...
    L.geoJson(dados, {
        ...
        onEachFeature: function (feature, layer) {
            ...
            layer.bindPopup("<h2>" + feature.properties.bairro_nome + "</h2><button type='button' class='btn btn-primary' title='Novo Comentário' onclick='AbrirModalComentario(" + feature.properties.bairro_codigo + ",&#96;" + feature.properties.bairro_nome + "&#96;)'>+</button><br/><i id='" + feature.properties.bairro_codigo + "' class='fa fa-thumbs-o-up' onclick='openNavRight()' style='font-size:72px;color:green;' title='O que gostou?'></i><i class='fa fa-thumbs-o-down' style='font-size:72px;color:red;' title='O que não gostou?'></i>");
...
function ChamarBotao(codigo) {
    //var jsfCommandLink = document.getElementById("ChamarComentario");
    //jsfCommandLink.title = codigo;
